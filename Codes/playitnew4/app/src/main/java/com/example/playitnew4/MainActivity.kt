...
import com.example.playitnew4.*
import com.example.playitnew4.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        val currentTheme = arrayOf(R.style.coolPink, R.style.coolBlue, R.style.coolPurple, R.style.coolOrange, R.style.coolGreen)
        val currentThemeNav = arrayOf(R.style.coolPinkNav, R.style.coolBlueNav, R.style.coolPurpleNav, R.style.coolOrangeNav,
            R.style.coolGreenNav)
        val currentGradient = arrayOf(R.drawable.gradient_pink, R.drawable.gradient_blue, R.drawable.gradient_purple, R.drawable.gradient_orenge,
